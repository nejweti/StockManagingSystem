...
public class TinyDB {
    ...
    public ArrayList<Depolar> getListObject(String key, ArrayList<Depolar> mClass){
    	Gson gson = new Gson();

    	ArrayList<String> objStrings = getListString(key);
    	ArrayList<Depolar> objects =  new ArrayList<Depolar>();

    	for(String jObjString : objStrings){
    		Depolar value  = gson.fromJson(jObjString, Depolar.class);
    		objects.add(value);
    	}
    	return objects;
    }
...
//    }
//
    public void putListObject(String key, ArrayList<Depolar> objArray){
    	checkForNullKey(key);
    	Gson gson = new Gson();
    	ArrayList<String> objStrings = new ArrayList<String>();
    	for(Depolar obj : objArray){
